...
namespace IIvT_ProjectAPI.Persistence.Migrations
{
    ...
    [Migration("20250529061118_mig_user_event_addresses")]
    partial class mig_user_event_addresses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventEventAddress", b =>
                {
                    b.Property<Guid>("EventAddressesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("EventsId")
                        .HasColumnType("uuid");

                    b.HasKey("EventAddressesId", "EventsId");

                    b.HasIndex("EventsId");

                    b.ToTable("EventEventAddress");
                });
            ...
            modelBuilder.Entity("IIvT_ProjectAPI.Domain.Entities.EventAddress", b =>
                {
                    b.HasBaseType("IIvT_ProjectAPI.Domain.Entities.Address");

                    b.HasDiscriminator().HasValue("EventAddress");
                });
            ...
            modelBuilder.Entity("EventEventAddress", b =>
                {
                    b.HasOne("IIvT_ProjectAPI.Domain.Entities.EventAddress", null)
                        .WithMany()
                        .HasForeignKey("EventAddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IIvT_ProjectAPI.Domain.Entities.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IIvT_ProjectAPI.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("IIvT_ProjectAPI.Domain.Entities.Address", "Location")
                        .WithMany()
